        ...
        $callback = function() use($pendaftarans, $columns) {
            ...
            foreach ($pendaftarans as $p) {
                fputcsv($file, [
                    ...
                    $p->kategori ?? '-',
                    $p->pas_foto ? route('pendaftaran.file', ['type' => 'pas_foto', 'userId' => $p->user_id]) : '-',
                    $p->foto_ktp ? route('pendaftaran.file', ['type' => 'foto_ktp', 'userId' => $p->user_id]) : '-',
                    $p->industri?->unit_kerja ?? '-',
                    $p->industri?->jabatan ?? '-',
                    $p->industri?->golongan ?? '-',
                    $p->industri?->tanggal_mulai_kerja ?? '-',
                    $p->industri?->tanggal_pensiun ?? '-',
                    $p->industri?->surat_izin ? route('pendaftaran.file', ['type' => 'surat_izin', 'userId' => $p->user_id]) : '-',
                    $p->universitas?->nama_universitas ?? '-',
                    $p->universitas?->program_studi ?? '-',
                    $p->universitas?->kota ?? '-',
                    $p->universitas?->tanggal_mulai_studi ?? '-',
                    $p->universitas?->durasi_studi ?? '-',
                    $p->universitas?->loa ? route('pendaftaran.file', ['type' => 'loa', 'userId' => $p->user_id]) : '-',
                    $p->universitas?->khs_ipk ? route('pendaftaran.file', ['type' => 'khs_ipk', 'userId' => $p->user_id]) : '-',
                    ...
                    $p->rekomendasi?->file_rekomendasi ? route('pendaftaran.file', ['type' => 'file_rekomendasi', 'userId' => $p->user_id]) : '-',
                    $p->essay?->essay_kontribusi ?? '-',
                    $p->surat_komitmen ? route('pendaftaran.file', ['type' => 'surat_komitmen', 'userId' => $p->user_id]) : '-',
                    ucfirst($p->status),
                    $p->catatan ?? '-',

@extends('layouts.app')
@section('title', 'Pendaftaran - Tahap 6 (Ringkasan)')
...
<div class="max-w-5xl mx-auto mb-10">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-slate-200 p-8">
        ...
        <form id="final-form" action="{{ route('pendaftaran.step6.store') }}" method="POST" class="mt-10 pt-8 border-t border-slate-200">
            @csrf

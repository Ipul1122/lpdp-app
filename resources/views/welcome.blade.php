...
<head>
    ...
    <title>Portal Pendaftaran Beasiswa LPDP</title>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-20">
                <div class="flex items-center gap-3">
                    ...
                    <span class="font-bold text-xl tracking-tight text-slate-800">LPDP<span class="text-orange-500">App</span></span>
                </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center max-w-3xl mx-auto mt-10 md:mt-20">
                ...
                <h1 class="text-4xl md:text-6xl font-extrabold text-slate-900 tracking-tight leading-tight mb-6">
                    Wujudkan Mimpimu dengan <span class="text-transparent bg-clip-text bg-gradient-to-r from-orange-500 to-amber-500">Beasiswa LPDP</span>
                </h1>
    ...
    <footer class="bg-white border-t border-slate-200 py-10 mt-auto">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between items-center gap-4">
            <div class="flex items-center gap-2">
                ...
                <span class="font-bold text-slate-800">LPDPApp</span>
            </div>
